...
public class FormLogin extends javax.swing.JFrame {
    ...
    try {
        String sql = "SELECT * FROM users WHERE username = ? AND password = ? AND akses = ?";
        ...
        if (res.next()) {
            // Jika login berhasil, ambil data pengguna dari hasil query
            // Sesuaikan nama kolom "id" dan "username" jika berbeda di database Anda
            String idUser = res.getString("id"); 
            String namaUser = res.getString("username"); // Kita gunakan username sebagai nama

            JOptionPane.showMessageDialog(null, "Login Berhasil sebagai " + akses);

            // Cek hak akses dan kirim data user ke dashboard yang sesuai
            if (akses.equals("Admin")) {
                new DashboardAdmin(idUser, namaUser).setVisible(true);
            } else if (akses.equals("Pegawai")) {
                new DashboardUtama(idUser, namaUser).setVisible(true);
            }
            ...
            JOptionPane.showMessageDialog(this, "Username, Password, atau Hak Akses Salah!", "Login Gagal", JOptionPane.ERROR_MESSAGE);
        }
